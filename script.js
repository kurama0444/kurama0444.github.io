function updateAge() {
    ...
    if (currentMonth < 6 || (currentMonth === 6 && currentDay < 20)) { // July 20th = month 6, day 20
        age--;
    }
...
function updateTimer() {
    ...
    // This function is not currently used in index.html, but kept for completeness if a timer is added later.
...
// setInterval(updateTimer, 1000); // Not currently used, but can be uncommented if a timer is added to HTML
setInterval(updateBirthdayCountdown, 1000);
updateAge();
// updateTimer(); // Not currently used
